    ...
    ILogger<RemoveOrganizationMemberHandler> logger) : ICommandHandler<RemoveOrganizationMemberCommand>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (membership is null)
        {
            ...
            return Result.Failure(LocalizedMessage.Of("lockey_identity_error_user_not_in_org"));
        }
        ...
        return Result.Success(LocalizedMessage.Of("lockey_identity_member_removed"));
    }
}
