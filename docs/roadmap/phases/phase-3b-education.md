...
Education Edition is an orthogonal vertical to NGO (per ADR-0016: editions do not depend
...
2. Parent portal live via ADR-0017 manifest.
...
Parent portal (ADR-0017 manifest), waitlist, accreditation tracking, summer camp.

## Acceptance criteria

- [ ] `education` module spec exists under the Tier-3b folder.
- [ ] Parent portal surfaces via ADR-0017 manifest.
...
**Consumes:** ADR-0015, ADR-0016, ADR-0017, CRM + Subscription from Phase 2.
