# Legacy Roadmap (archived 2026-04-22)
> Original location: docs/roadmap/ROADMAP.md (kept in place until maintainer deletion).
> Replaced by: docs/roadmap/phases/phase-*.md + docs/roadmap/current.md (see ADR-015).
> Open items have been extracted into docs/_archive/migration-notes.md §2.
