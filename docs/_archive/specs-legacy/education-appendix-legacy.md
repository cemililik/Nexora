# Education SPEC — Legacy Appendix

Archived from tier-3b-education/education/SPEC.md during Phase 2 cleanup.

> The content below is the pre-rewrite source for this spec, preserved verbatim for traceability. It is superseded by the sections above and should not be treated as normative.

# Module: Education Management

**Tier:** 3b — Education Edition

> Prompt 02 will rewrite this spec.
